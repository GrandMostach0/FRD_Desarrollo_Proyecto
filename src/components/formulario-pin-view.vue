<template>
    <div class="flex gap-5 px-5 py-2 bg-gray-100 rounded-xl">
        <div class="flex-1">
            <div class="containerInputs">
                <label for="pinAutoizacion">Pin de autorización</label>
                <input type="text" name="pinAutoizacion" id="pinAutoizacion" readonly value="Baja">
            </div>
